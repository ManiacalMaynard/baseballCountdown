...
const majorOpeningDay = new Date('Mar 30, 2024 13:10:00').getTime();
const minorOpeningDay = new Date('Mar 31, 2024 01:05:00').getTime();
...
const changeLeague = () => {
  ...
  if (currentLeague == 'majorLeagueSelect') {
    ...
    document.getElementById('dateDisplay').innerText = 'March 31st, 2024';
  } else {
    ...
    document.getElementById('dateDisplay').innerText = 'March 30th, 2024';
  }
};
...
console.log(
  "Because it's one, two, three strike you're out at the old ball game!"
);
